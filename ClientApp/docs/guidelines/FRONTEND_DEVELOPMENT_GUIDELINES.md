...
- **@types/react**: Should match React version (19.x)
- **@types/react-dom**: Should match React version (19.x)
...
- **Only run Prettier on files you created or modified** (ClientApp files only)
...
- Add or update JSDoc when new functionality is added or existing functionality is changed
...
- **Check the IDE Problems panel** for errors and warnings before handing off changes
